 ...
 */
package android.support.v4.media.browse;
...
public class MediaBrowserCompat {
    ...
    private final void onLoadChildren(final IMediaBrowserServiceCompatCallbacks callback,
                                      final String parentId, final ParceledListSliceCompat list) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    private static class ServiceCallbacks extends IMediaBrowserServiceCompatCallbacks.Stub {
        ...
        @Override
        public void onLoadChildren(final String parentId, final ParceledListSliceCompat list) {
            MediaBrowserCompat mediaBrowser = mMediaBrowser.get();
            if (mediaBrowser != null) {
